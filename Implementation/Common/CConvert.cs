// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CConvert.cs" company="John Allberg">
...
// </copyright>
// <summary>
//   Summary description for convert class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Allberg.Shooter.Common
{
    ...
    /// <summary>
    /// Static class to convert between different types of classes.
    /// </summary>
    [Serializable]
    internal class CConvert
    {
        /// <summary>
        /// The convert weapons class to result class.
        /// </summary>
        /// <param name="weapon">
        /// The weapon class.
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// The <see cref="Structs.ResultWeaponsClass"/>.
        /// </returns>
        internal static Structs.ResultWeaponsClass ConvertWeaponsClassToResultClass(
        ...
        /// <summary>
        /// The convert weapons class to patrol class.
        /// </summary>
        /// <param name="weapon">
        /// The weapon.
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// The <see cref="Structs.PatrolClass"/>.
        /// </returns>
        internal static Structs.PatrolClass ConvertWeaponsClassToPatrolClass(
            Structs.WeaponClass weapon,
            Structs.PatrolConnectionTypeEnum type)
        {
            var returnClass = Structs.PatrolClass.Okänd;
