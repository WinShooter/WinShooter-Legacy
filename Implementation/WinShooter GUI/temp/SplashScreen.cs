...
namespace Allberg.Shooter.Windows
{
	...
	public class SplashScreen : System.Windows.Forms.Form
	{
		...
		private Allberg.Shooter.Windows.Forms.SafeLabel lblStatus;
		private Allberg.Shooter.Windows.Forms.SafeLabel lblTimeRemaining;
		...
		public SplashScreen()
		{
			...
			timer1.Start();
			//this.BackgroundImage = Allberg.Shooter.Common.CEmbeddedResources.GetEmbeddedPicture("Allberg.Shooter.Common.Splash.bmp");
		...
		static public void ShowSplashScreen()
		{
			...
			ms_oThread.Name = "SplashScreen Thread";
		...
		private void pnlStatus_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			...
			{
				LinearGradientBrush brBackground = new LinearGradientBrush(m_rProgress, Color.FromArgb(50, 50, 100), Color.FromArgb(150, 150, 255), LinearGradientMode.Horizontal);
